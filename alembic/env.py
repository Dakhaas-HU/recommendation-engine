...
from database.migrations import create_products_table, create_profiles_table, \
    create_previously_recommended, create_sessions_table, create_viewed_before_table, \
    create_order_table, create_viewed_brand_table, \
...
target_metadata = [create_products_table.Base.metadata, create_profiles_table.Base.metadata,
                   ...
                   create_order_table.Base.metadata, create_viewed_brand_table.Base.metadata, create_viewed_category_table.Base.metadata,
